...
!$ACDC GENERATE, TARGET=SyncDevice
!$ACDC GENERATE, TARGET=SyncHost/Parallel/SingleColumnFieldAPIHost/FieldAPIHost
...
!$ACDC PARALLEL, TARGET=DEVICE, VECTOR=SINGLECOLUMN, DIRECTIVE=OPENACC, OUTLINE=1 {

!#PARALLEL TARGET=DEVICE,VECTOR=SINGLECOLUMN,POST=SYNCHOST
!#PARALLEL TARGET=HOST,VECTOR=BLOCK

...
IF (YDCPG_OPTS%LDIAB.OR.(YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH.AND.(.NOT.YDMODEL%YRML_PHY_MF%YRSIMPHL%LTRAJPS))) THEN  
  IF (LLCALL_CPCFU.OR.LLCALL_CPXFU.OR.LLCALL_CUMCPLDM) THEN
    DO JLEV=0,YDCPG_OPTS%KFLEVG
      ZSTRCU(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=ZSTRCU(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)/YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
      ZSTRCV(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=ZSTRCV(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)/YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
      ZSTRDU(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=ZSTRDU(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)/YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
      ZSTRDV(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=ZSTRDV(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)/YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
      ZSTRTU(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=ZSTRTU(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)/YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
      ZSTRTV(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=ZSTRTV(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)/YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
    ENDDO
  ENDIF
  IF (LLCALL_CPXFU .OR. YDMODEL%YRML_PHY_G%YRDPHY%LDIRCLSMOD) THEN
    ZUCLS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=ZUCLS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)  /YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
    ZVCLS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=ZVCLS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)  /YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
    ZNUCLS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=ZNUCLS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)/YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
    ZNVCLS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=ZNVCLS(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)/YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
    ZUGST(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=ZUGST(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)  /YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
    ZVGST(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)=ZVGST(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)  /YDVARS%GEOMETRY%GM%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA)
  ENDIF
ENDIF

...
#include "cpg_dia_flu_single_column.intfb.h"
...
LOGICAL :: LLDIFF, LLSINGLECOLUMN, LLSYNCHOST, LLPARALLELVIEW
  ...
  DO IBL = 1, NGPBLKS
    ...
    IF (LLSINGLECOLUMN) THEN
      ...
      DO JLON = YLCPG_BNDS%KIDIA, YLCPG_BNDS%KFDIA
        ...
        CALL CPG_DIA_FLU_SINGLE_COLUMN (YLCPG_BNDS1, YLCPG_OPTS, YLCPG_MISC, YLMF_PHYS_OUT, YLCPG_DYN0, &
                                      & YLMF_PHYS_SURF, YLVARS, YLCFU, YLXFU, YLMODEL)
      ENDDO
    ELSE

...
PRINT *, YLXFU%F_CAPE%PTR (1, 1)

!$acc serial present (YLXFU)
PRINT *, " DEV ", YLXFU%F_CAPE%DEVPTR (1, 1)
!$acc end serial

PRINT *, " HOST ", YLXFU%F_CAPE%DEVPTR (1, 1)

CALL YLXFU%F_CAPE%SYNC_DEVICE_RDONLY
...
PRINT *, YLXFU%F_CAPE%PTR (1, 1)
PRINT *, YLXFU_REF%F_CAPE%PTR (1, 1)

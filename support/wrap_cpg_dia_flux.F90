...
NGPBLKS = SIZE (YLCPG_DYN0%F_PHI%PTR, 3)

PRINT *, " NPROMA, NGPBLKS = ", NPROMA, NGPBLKS

CALL CPG_DIA_FLU_PLAN (YLCPG_BNDS, YLCPG_OPTS, YLCPG_MISC, YLMF_PHYS_OUT, YLCPG_DYN0, YLMF_PHYS_SURF, YLVARS, YLCFU, YLXFU, YLMODEL)

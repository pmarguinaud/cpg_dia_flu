...
LOGICAL :: LLDIFF, LLUPDATE, LLSINGLECOLUMN, LLPLAN, LLPARALLEL
...
CALL GETOPTION ("--plan", LLPLAN)
CALL GETOPTION ("--update", LLUPDATE)
...
IF (LLPLAN) THEN
  CALL CPG_DIA_FLU_PLAN (YLCPG_BNDS, YLCPG_OPTS, YLCPG_MISC, YLMF_PHYS_OUT, YLCPG_DYN0, &
...
DO ITIME = 1, NTIME
  ...
  IF (LLPARALLEL) THEN
    YLCPG_BNDS%KBL = 56
    CALL CPG_DIA_FLU_PARALLEL (YLCPG_BNDS, YLCPG_OPTS, YLCPG_MISC, YLMF_PHYS_OUT, YLCPG_DYN0, &

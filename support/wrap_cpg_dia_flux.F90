...
CHARACTER*32 :: CLFILE, CLPROC
INTEGER (KIND=JPIM) :: IBL, NGPBLKS, NPROMA
...
CLFILE = "YDMODEL.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLMODEL)
CLOSE (77)

CLFILE = "YDVARS.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLVARS)
CLOSE (77)

CLFILE = "YDCPG_OPTS.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLCPG_OPTS)
CLOSE (77)

CLFILE = "YDCPG_BNDS.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLCPG_BNDS)
CLOSE (77)

CLFILE = "YDCPG_MISC.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLCPG_MISC)
CLOSE (77)

CLFILE = "YDCPG_DYN0.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLCPG_DYN0)
CLOSE (77)

CLFILE = "YDXFU.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLXFU)
CLOSE (77)

CLFILE = "YDCFU.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLCFU)
CLOSE (77)

CLFILE = "YDMF_PHYS_OUT.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLMF_PHYS_OUT)
CLOSE (77)

CLFILE = "YDMF_PHYS_SURF.IN"//TRIM (CLPROC)
OPEN (77, FILE=TRIM (CLFILE), FORM='UNFORMATTED', STATUS='OLD')
CALL LOAD (77, YLMF_PHYS_SURF)
CLOSE (77)

NPROMA = SIZE (YLCPG_DYN0%F_PHI%DATA, 1)
NGPBLKS = SIZE (YLCPG_DYN0%F_PHI%DATA, 3)

PRINT *, " NPROMA, NGPBLKS = ", NPROMA, NGPBLKS

DO ITIME = 1, NTIME

!$OMP PARALLEL PRIVATE (IBL) FIRSTPRIVATE (YLVARS, YLMF_PHYS_SURF, YLCPG_DYN0, YLCPG_MISC, YLMF_PHYS_OUT, YLCPG_BNDS, YLXFU, YLCFU)
...
DO IBL = 1, NGPBLKS
  ...
  CALL CPG_DIA_FLU (YLCPG_BNDS, YLCPG_OPTS, YLCPG_MISC, YLMF_PHYS_OUT, YLCPG_DYN0, YLMF_PHYS_SURF, YLVARS, YLCFU, YLXFU, YLMODEL)

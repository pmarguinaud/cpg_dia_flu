...
INTEGER :: J1, J2
LOGICAL :: LYA, LYAERAOT, LYAERLISI, LYAERO, LYAEROCLIM, LYAEROUT, LYCHEM, LYCPF, LYCRM, LYCVGQ, LYCVV, LYDAL, LYDOM, LYEDRP, LYEFB1, LYEFB2, LYEFB3, LYERA40, LYEXT, LYEZDIAG, LYFORC, LYFQTUR, LYFSD, LYFSTUR, LYG, LYGHG, LYH, LYI, LYICONV, LYIRAD, LYL, LYLASTCOMP, LYLCONV, LYLIMA, LYLRAD, LYLRCH4, LYMXL, LYNOGW, LYO3, LYPHYCTY, LYPHYS, LYQ, LYQVA, LYR, LYRCONV, LYRKTH, LYRKTQC, LYRKTQV, LYRSPEC, LYS, LYSCONV, LYSDSAT, LYSHTUR, LYSLDIA, LYSPF, LYSRC, LYTKE, LYTTE, LYUAL, LYUEN, LYUNEBH, LYUOM, LYUVP

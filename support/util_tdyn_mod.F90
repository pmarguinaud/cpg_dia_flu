...
LOGICAL :: LRCORDIF, LRCORDIH, LRCORDIT, LRDHI, LRDHS, LRDIDIV, LRDIGFL, LRDIPD, LRDISP, LRDITG, LRDIVD, LRDIVOR, LRDSDIV, LRDSVD, LRDSVOR, LRKRF, LSIALPH, LSIB, LSIBI, LSIDELP, LSIDPHI, LSIFAC, LSIFACI, LSIHEG, LSIHEG2, LSIHEGB, LSIHEGB2, LSILNPR, LSIMI, LSIMO, LSIRDEL, LSITLAF, LSITLAH, LSITRAM, LSIVP, LSIWEIG, LSI_ILAPKSSI, LSLHDA, LSLHDD0, LSLHD_MASK_T, LSLHD_MASK_U
WRITE (KLUN) YD%REPS1
WRITE (KLUN) YD%REPS2

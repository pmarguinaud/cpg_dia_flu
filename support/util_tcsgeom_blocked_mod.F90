...
CLASS (TCSGEOM_BLOCKED), INTENT (IN), TARGET :: YD
...
IMPLICIT NONE
INTEGER, INTENT (IN) :: KLUN
CLASS (TCSGEOM_BLOCKED), INTENT (OUT), TARGET :: YD
INTEGER :: IL2(2), IU2(2)
LOGICAL :: LRATATH, LRATATX, LRCOLON, LRINDX, LRINDY, LRSILON
...
SUBROUTINE COPY_TCSGEOM_BLOCKED (YD, LDCREATED)
IMPLICIT NONE
CLASS (TCSGEOM_BLOCKED), INTENT (IN), TARGET :: YD
...
SUBROUTINE WIPE_TCSGEOM_BLOCKED (YD, LDDELETED)
IMPLICIT NONE
CLASS (TCSGEOM_BLOCKED), INTENT (IN), TARGET :: YD

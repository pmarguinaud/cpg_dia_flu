MODULE UTIL_VARIABLE_3D_MOD

USE VARIABLE_MODULE, ONLY : VARIABLE_3D

INTERFACE SAVE
MODULE PROCEDURE SAVE_VARIABLE_3D
END INTERFACE

INTERFACE LOAD
MODULE PROCEDURE LOAD_VARIABLE_3D
END INTERFACE

INTERFACE COPY
MODULE PROCEDURE COPY_VARIABLE_3D
END INTERFACE

INTERFACE WIPE
MODULE PROCEDURE WIPE_VARIABLE_3D
END INTERFACE
...
SUBROUTINE SAVE_VARIABLE_3D (KLUN, YD)
USE UTIL_FIELD_MOD
USE UTIL_VARIABLE_BASE_MOD, ONLY : VARIABLE_BASE, SAVE_VARIABLE_BASE
IMPLICIT NONE
INTEGER, INTENT (IN) :: KLUN
TYPE (VARIABLE_3D), INTENT (IN), TARGET :: YD
...
SUBROUTINE LOAD_VARIABLE_3D (KLUN, YD)
USE UTIL_FIELD_MOD
USE UTIL_VARIABLE_BASE_MOD, ONLY : VARIABLE_BASE, LOAD_VARIABLE_BASE

IMPLICIT NONE
INTEGER, INTENT (IN) :: KLUN
TYPE (VARIABLE_3D), INTENT (OUT), TARGET :: YD
CLASS (VARIABLE_BASE), POINTER :: YLSUPER
LOGICAL :: LFDL, LFDL9, LFDM, LFDM9, LFPH9, LFT0, LFT1, LFT9
YLSUPER => YD
...
SUBROUTINE COPY_VARIABLE_3D (YD, LDCREATED)
USE UTIL_FIELD_MOD
...
SUBROUTINE WIPE_VARIABLE_3D (YD, LDDELETED)
USE UTIL_FIELD_MOD

...
CLASS (TELBC_MODEL), INTENT (IN), TARGET :: YD
...
IMPLICIT NONE
INTEGER, INTENT (IN) :: KLUN
CLASS (TELBC_MODEL), INTENT (OUT), TARGET :: YD
...
SUBROUTINE WIPE_TELBC_MODEL (YD, LDDELETED)
IMPLICIT NONE
CLASS (TELBC_MODEL), INTENT (IN), TARGET :: YD
...
IF (LEALFA_GMV) THEN
  ...
  !$acc exit data delete (YD%EALFA_GMV)
ENDIF

LEALFA_GMVS = ALLOCATED (YD%EALFA_GMVS)
IF (LEALFA_GMVS) THEN
  !$acc exit data detach (YD%EALFA_GMVS)
  !$acc exit data delete (YD%EALFA_GMVS)
ENDIF

LEALFA_GFL = ALLOCATED (YD%EALFA_GFL)
IF (LEALFA_GFL) THEN
  !$acc exit data detach (YD%EALFA_GFL)
  !$acc exit data delete (YD%EALFA_GFL)
ENDIF

LEALFA_TENC = ALLOCATED (YD%EALFA_TENC)
IF (LEALFA_TENC) THEN
  !$acc exit data detach (YD%EALFA_TENC)
  !$acc exit data delete (YD%EALFA_TENC)
ENDIF

LEALFAGT3GMV = ALLOCATED (YD%EALFAGT3GMV)
IF (LEALFAGT3GMV) THEN
  !$acc exit data detach (YD%EALFAGT3GMV)
  !$acc exit data delete (YD%EALFAGT3GMV)
ENDIF

LEALFAGT3GMVS = ALLOCATED (YD%EALFAGT3GMVS)
IF (LEALFAGT3GMVS) THEN
  !$acc exit data detach (YD%EALFAGT3GMVS)
  !$acc exit data delete (YD%EALFAGT3GMVS)
ENDIF

LEALFAGT3GFL = ALLOCATED (YD%EALFAGT3GFL)
IF (LEALFAGT3GFL) THEN
  !$acc exit data detach (YD%EALFAGT3GFL)
  !$acc exit data delete (YD%EALFAGT3GFL)
ENDIF

LEALFAU_GMV = ALLOCATED (YD%EALFAU_GMV)
IF (LEALFAU_GMV) THEN
  !$acc exit data detach (YD%EALFAU_GMV)
  !$acc exit data delete (YD%EALFAU_GMV)
ENDIF

LEALFAU_GFL = ALLOCATED (YD%EALFAU_GFL)
IF (LEALFAU_GFL) THEN
  !$acc exit data detach (YD%EALFAU_GFL)
  !$acc exit data delete (YD%EALFAU_GFL)
ENDIF

LGMGT3 = ALLOCATED (YD%GMGT3)
IF (LGMGT3) THEN
  !$acc exit data detach (YD%GMGT3)
  !$acc exit data delete (YD%GMGT3)
ENDIF

LGMGT4 = ALLOCATED (YD%GMGT4)
IF (LGMGT4) THEN
  !$acc exit data detach (YD%GMGT4)
  !$acc exit data delete (YD%GMGT4)
ENDIF

LEWB = ALLOCATED (YD%EWB)
IF (LEWB) THEN
  !$acc exit data detach (YD%EWB)
  !$acc exit data delete (YD%EWB)
ENDIF

LEWBDFIFW = ALLOCATED (YD%EWBDFIFW)
IF (LEWBDFIFW) THEN
  !$acc exit data detach (YD%EWBDFIFW)
  !$acc exit data delete (YD%EWBDFIFW)
ENDIF

LEWBDFIBW = ALLOCATED (YD%EWBDFIBW)
IF (LEWBDFIBW) THEN
  !$acc exit data detach (YD%EWBDFIBW)
  !$acc exit data delete (YD%EWBDFIBW)
ENDIF
...
IF (LLNUDSPGFL) THEN
  ...
  !$acc exit data delete (YD%LNUDSPGFL)
ENDIF
